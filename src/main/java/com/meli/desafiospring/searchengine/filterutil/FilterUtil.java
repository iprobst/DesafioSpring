package com.meli.desafiospring.searchengine.filterutil;
...
public class FilterUtil {
    ...
    public static List<ArticleDTO>  filterBy(List<ArticleDTO> articles, Optional<String> category, Optional<Integer> freeShipping){
